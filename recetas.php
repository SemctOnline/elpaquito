...
<head>
  ...
  <link rel="shortcut icon" href="images/logo-paquito-claim.png" type="">
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="recetas.php">Recetas de Paquito</a>
              </li>
              <li class="nav-item">
  ...
  <section class="food_section layout_padding">
    <div class="container">
      ...
      <ul class="filters_menu">
        ...
        <li data-filter=".burger">Barcelona</li>
        <li data-filter=".pizza">Madrid</li>
        <li data-filter=".pasta">Valencia</li>
        <li data-filter=".fries">Villadolid</li>
        <li data-filter=".fries">Zamora</li>
